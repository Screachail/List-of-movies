...
MOVIE_DB_API_KEY = "0d85a6076b5627c326e82275d820bd66"
...
# Use this code once, then comment it to disable!
new_movie = Movie(
     title="Phone Booth",
     year=2002,
...
db.session.commit()
# This is the end of code that you should comment to disable after first use
